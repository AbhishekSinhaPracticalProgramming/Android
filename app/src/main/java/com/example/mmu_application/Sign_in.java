...
public class Sign_in extends AppCompatActivity implements View.OnClickListener {
    private TextInputEditText email, password,passkey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passkey=findViewById(R.id.passkey_id);


        singinButton.setOnClickListener(this);
        signup.setOnClickListener(this);
        studentLoginText.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.signin_button_id:
                ...
                String passkey_string = passkey.getText().toString().trim();
                if(passkey_string.equals("admin2020"))
                {
                    usersingnin();
                }
                else{

                    passkey.setError("Invalid Pass-Key !");
            ...
            case  R.id.login_as_student_id:

                Intent intent1 = new Intent(getApplicationContext(),Student_Sign_in.class);
    ...
    private void usersingnin() {
        ...
        if (passkey_string.isEmpty()) {
            passkey.setError("Enter Admin Security Pass-key");
            passkey.requestFocus();
            return;
        }
